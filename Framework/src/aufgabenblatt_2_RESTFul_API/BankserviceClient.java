...
{	
	...
	{		
		...
		posteNeuenKunden(t,				 new Kunde      ("Duendar" , "Humboldtstrasse 064"));
		posteNeuenKunden(t,				 new Kunde      ("Brueckel" , "Humboldtstrasse 064"));
		getKunde(t, "Duendar");
		getKunde(t, "Brueckel");
		posteNeuesKonto (t,	"Duendar",     "85");
		posteNeuesKonto (t,	"Brueckel",   "285");
		posteNeuesKonto (t,	"Duendar",   "1085");
		...
		getAlleKontenEinensKunden(t, "Duendar");
		getAlleKunden(t);
